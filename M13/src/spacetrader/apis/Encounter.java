...
public class Encounter {
	...
	public String getOppAction(int oppType) {
		if (oppType == 0) {
			...
			if (num == 0) {
				...
				int life = ps.getBase().getHullStrength() - encounteredShip.getAttack();
	...
	public Ship getOppShip() {
		return encounteredShip;
	}
	
	public String getOpShipType(){
		return encounteredShip.getName();
	}
